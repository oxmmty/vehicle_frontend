...
const MonthlyCustomerPage = () => {
  ...
  const inseartHeader = () => {
    const header = ['前月', '翌末', '翌々末', '合計', '小計', '', '支払合計(課税＋非課税）', '差益', '差益率', '売上前月比', '売上前年同月比', '得意先売上', '得意先下払利率', '協力会社売上', '協力会社下払利率']
  ...
  return (
    <div className='flex flex-col gap-0'>
      <DatePicker onChange={onChange} defaultValue={dayjs(date, 'YYYY-MM')} className='grow max-w-96' picker='month' />
