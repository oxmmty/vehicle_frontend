...
const InvoicePage = () => {
  ...
  const dataSource = [
    { key: "0", name: "課税（10％対象）", value: 8193 },
  ...
  const orderColumns = [
    { title: "受注コード", dataIndex: "code", key: "code" },
    { title: "日付", dataIndex: "date", key: "date" },
    { title: "積地", dataIndex: "loading", key: "loading" },
    { title: "配達先", dataIndex: "deliver", key: "deliver" },
    { title: "品目", dataIndex: "item", key: "item" },
    { title: "種類", dataIndex: "kind", key: "kind" },
    { title: "区分", dataIndex: "classify", key: "classify" },
    {
      title: "基本料金",
      dataIndex: "basicMount",
      key: "basicMount",
    ...
    { title: "小計", dataIndex: "subTotal", key: "subTotal" },
    { title: "消費税", dataIndex: "tax", key: "tax" },
    { title: "合計", dataIndex: "sum", key: "sum" },
    { title: "備考", dataIndex: "remark", key: "remark" },
  ];
  ...
  const handlePrint = () => {
    ...
    const printWindow = window.open("", "", "width=1920,height=3000");
    printWindow.document.write(`
      <html>
        ...
        <body>
          <h2 style="text-align:center;">御請求書</h2>
          ${printContent}
        </body>
      </html>
    `);
  ...
  return (
    <div className="flex flex-col justify-center w-full" ref={invoiceRef}>
      <Title level={2} className="m-auto">
        御請求書
      </Title>
      <Divider className="w-full m-2" />
