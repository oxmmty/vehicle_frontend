      ...
      <>
        <Route element={<App />} errorElement={<Error />}>
          <Route element={<Private />} loader={async () => {
            ...
            <Route path="/orders_invoices" loader={() => redirect('/orders_invoices/newOrderForm')} />
            <Route path="/orders_invoices/newOrderForm" element={<NewOrderFormPage />} />
            ...
            <Route path="/calendar_schedules/dispatchSpecification" element={<DispatchSpecificationPage />} />
            ...
            <Route path="/masterDatas/partnerCompany" element={<NewPage />} />
            ...
            <Route path="/analysis_reports/transportCompanyRequest" element={<TransportCompanyRequestPage />} />

            <Route path="/document_notes" loader={() => redirect('/document_notes/releaseNotes')} />
            <Route path="/document_notes/releaseNotes" element={<ReleaseNotesPage />} />
